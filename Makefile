...
PLATE_FILES=data/RMC-JB-001_AH22TCBGX9_S1_R2.TranscriptCounts.tsv.gz \
	data/RMC-JB-002_AH22TCBGX9_S2_R2.TranscriptCounts.tsv.gz \
	data/RMC-JB-003_AH22TCBGX9_S3_R2.TranscriptCounts.tsv.gz
